...
const COLUMNS = [
  ...
  { key: 'base',         label: 'Base Amount',          required: true,  example: '10000',                  hint: 'Numeric, no currency symbol' },
  ...
  { key: 'total',        label: 'Total (incl. GST)',    required: true,  example: '11800',                  hint: 'Numeric, no currency symbol' },
